 ...
 * JS评分效果
 */
 // r_ Scroe.protptype必须放在new Scroe前面,这里没有变量提升
 ...
 Score.prototype = {
	...
	init: function(options){
		this.config = $.extend(this.config,options || {});		// extend(dest,src1,src2,src3...); 它的含义是将src1,src2,src3...合并到dest中 $.extend(src) 该方法就是将src合并到jquery的全局对象中去
		var self = this,										//这里this指的是新的对象本身 包括prototype传承下来的内容
			_config = self.config,					
			_cache = self.cache;
